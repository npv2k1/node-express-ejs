...
function Toast(t) {
  ...
  (this.options = t),
    (this.options.type = t.type || "default"),
...
(Toast.prototype._createElements = function () {
  ...
  (Toast.prototype._close = function () {
    ...
    return new Promise(function (e, o) {
      t.toastContainerEl.setAttribute("aria-hidden", !0),
        setTimeout(function () {
          (t.toastEl.innerHTML = ""),
            t.toastEl.classList.remove(
              "default",
              "success",
              "warning",
              "danger"
            ),
            t.focusedElBeforeOpen && t.focusedElBeforeOpen.focus(),
            e();
        }, 1e3);
    });
  }),
  (Toast.prototype._open = function () {
    this.toastEl.classList.add(this.options.type),
      this.toastContainerEl.setAttribute("aria-hidden", !1);
    var t = "";
    this.options.customButtons &&
  ...
  (Toast.prototype._init = function () {
    ...
    Promise.resolve()
      ...
      .then(function () {
        return "false" == t.toastContainerEl.getAttribute("aria-hidden")
          ? t._close()
          : Promise.resolve();
      })
      .then(function () {
